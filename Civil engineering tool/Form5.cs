...
namespace Civil_engineering_tool
{
    public partial class Form5 : Form
    {
        ...
        {
            this.Text = "Circular footing: " + Form1.instance.picked_button.Text;
        ...
        public void calculation_btn_Click(object sender, EventArgs e)
        {
            ...
            if (menu_1 == 1 && menu_2 == 1 && menu_3 == 1)
            {
                ...
                weight_of_footing = Double.Parse(unit_weight_conc.Text) * Math.PI / 4 * Math.Pow(Double.Parse(footing_L.Text), 2);
                ...
                prov_area = Math.PI / 4 * Math.Pow(Double.Parse(footing_L.Text), 2);
                ...
                double crit_perim = Math.PI * (Double.Parse(col_dimension.Text) / 1000 + eff_depth);
                ...
                double col_Ag = Math.PI / 4 * Math.Pow(Double.Parse(col_dimension.Text), 2);
